...
static rosidl_typesupport_introspection_c__MessageMember motordriver_msgs__msg__MotordriverMessage__rosidl_typesupport_introspection_c__MotordriverMessage_message_member_array[4] = {
  {
    "encoder1",  // name
